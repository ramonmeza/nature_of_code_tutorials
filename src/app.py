...
from lessons.random_walker import RandomWalker
...
class App:
    ...
    def _initialize_gui(self) -> None:
        ...
        self._fps_counter = gui.elements.UILabel(pyg.Rect((0, 0), (1550, 20)), 'FPS', self._gui_manager)

    def _initialize_lesson(self) -> None:
        self._lesson = RandomWalker()
    ...
    def _render(self) -> None:
        ...
        self._window.blit(pyg.transform.scale(self._lesson, self._window.get_rect().size), (0, 0))
